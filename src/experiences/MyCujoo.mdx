...
company: MyCujoo (acq. by Elevensports, acq. by DaZN)
...
UI library that pulled data from our GraphQL APIs and displayed event cards, video player
...
(React/TypeScript + react-query, Cypress for testing, GraphQL APIs), lead front end
developer
...
progressive mobile web app), lead front end developer
* Built various npm UI libraries to use across different projects (React/TypeScript,
storybook + Jest to test and document)